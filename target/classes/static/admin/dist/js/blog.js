$(function () {
    $("#jqGrid").jqGrid({
        ...
        datatype: "json",
        colModel: [
            {label: 'id', name: 'id', index: 'blogId', width: 50, key: true, hidden: true},
            {label: '标题', name: 'tittle', index: 'blogTitle', width: 140},
            {label: '浏览量', name: 'reading', index: 'blogViews', width: 60},
            {label: '状态', name: 'status', index: 'blogStatus', width: 60, formatter: statusFormatter},
            {label: '博客分类', name: 'category', index: 'blogCategoryName', width: 60},
